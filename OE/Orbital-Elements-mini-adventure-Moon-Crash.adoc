...
*Jerroopus:* Modey flagged the target at Nuvo Sputnika. Modey must be worried that they'll get cheated out of their full cut. This means the target must be some serious bank. DON'T MAKE THEM EXPLODE. I want a forced landing, not another burnt wreck.
____
