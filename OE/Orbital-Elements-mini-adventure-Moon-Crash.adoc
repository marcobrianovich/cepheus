...
image:https://dub01pap003files.storage.live.com/y4m7igoym7kIwMZTJMdl0ilGO7rfEX8-fPmVqz4qTEY5zVo9ELZ4UFyk0vu52LG5LmoPJ2BQDi6WCodBkUgucjncCsEgrQaSLxCk5lzN22ljkH19NKsUj2_vZDYuyPKm9tnwXS9Z2IGs2UCYb9hKFwzz-DaELUdACvQkm4sH3XdYNIaYdCiOSYhJ-OskNGXWOO8kCh0R5UjcKuzg52Pd_RauvvOPYPj88cGCfzRMYbR2ro?encodeFailures=1&width=1871&height=922[Cover]
...
In this one-shot adventure, the PCs are the crew of a small transport rig that carries passengers and cargo between the countless Luna settlements. The adventure begins part way through a journey from Nuvo Sputnika to Copernicus Arc. The transport is hit by a ground based weapon, forcing a crash landing, right in the middle of a no man's land region that is littered with automated weapon systems left over from the Luna War II. The area is littered by smart jammers, so there's no radio communication, so no way to call for help. The PCs must try to lead their passengers to safety, walking across a trackless waste, filled with unseen dangers.
...
At Nuvo Sputnika, Percy approached several transport services, specifically asking if they can provide an off-the-grid transit. This request was overheard by Sam Modey, a pirate working at Nuvo Sputnika's port who looks for high value targets for ambush. She assumes that Percy is carrying something of very high value, of such high value that not only does she target Percy's transport for ambush, she agrees to risk travelling on the transporter herself, signing up as a passenger using a stolen identify (Zena Platts). Shortly after leaving Nuvo Sputnika, Sam activated her own beacon, sending the transport's position to her a pirate team. The beacon allows the pirates to quickly travel to one of several hidden weapon systems along the PC's route. When the PC's transport flies close, it is shot twice by a railgun emplacement. The shots are carefully targetted, so that the transporter is forced to make a hard landing, but is not so badly damaged that the transporter can't make a survivable landing. 
