...
|2        | Small surface debris. Roll on the debris table.
|3        | Small surface debris. Roll on the debris table. Add +1 to the roll.
|4        | Crash site. Roll on the crash site table.
|5        | Small ruin. Roll on the ruins table
