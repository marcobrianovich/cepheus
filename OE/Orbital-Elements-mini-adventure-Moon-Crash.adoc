...
[width=50%]
|===========================
1D6 | *Debris Encounter Table* _Each time you make a roll on this table, add an additional +1 to each subsquent roll._ 
|1        | Scattered rocks
...
[width=50%]
|===========================
1D6 | *Small Ruin Encounter Table*
