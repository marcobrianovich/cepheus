...
We have come a long from from building calculators out of leech neurons and building fungal computers, but we must acknowledge that our achievement is but the latest step in a journey that began with such work. Luduan-2 is the answer to the question, "Is wetware computing the ideal path for replicating human-like thought?" Well Luduan-2 tells me, yes, it thinks that it is.
