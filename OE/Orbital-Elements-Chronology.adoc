...
> While expert systems are getting better and better, it feels like the development of sentient machines is going backwards as we learn that the problem of self-awareness is more complicated than we ever thought. I predict that we will never create human-like intelligence so long ad we try to fashion them out of silicon.
* -Dr Mavis Kripps, General AI Symposium 2042*
