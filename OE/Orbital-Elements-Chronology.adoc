...
*2125* Agathos Watch commandos attack and destroy an AMP belonging to a group of extremist advancers called "Prajapati" after a tip-off that the group had created an unbound MI. After the attack, rumours spread that the entire group of advancers working on the AMP had been fed by their unbound creation into the robot factories workings. The Unbound had refused or been unable to communicate with the Agathos defense agents, do the decision had been taken to destroy it.
