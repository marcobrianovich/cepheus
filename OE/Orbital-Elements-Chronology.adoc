...
*2053*  Biodiversity has been massively reduced. Vast areas of land become deserts. There are nearly constant violent hurricane storms. Human populations shift to archology structures where all living requirements are handled from within massive highrise structures, or under protective domes (for the wealthy). The world's ultra-wealthy face the confiscation of their wealth as part of the global effort to move humanity into archologies. A small group of billionaires, lead by Mars colony founder, Richard Venters fight the "reaper-tax" in the courts. During the years-long battle many of them find ways to shift capital off Earth, either to the orbitals, Luna or Mars. 
...
*2062*  The founder of Mars colony, Richard DeVenters passes away, aged 111. The Marsian colonisation effort proved to be far more difficult and costly than expected, but by the start of the 2060s there is increased interest and investment. Earth's wealthy start to see Mars, Luna and the planned "orbitals" as a potential havens from the increased chaos and uncertainty of Earth-bound life. 
...
A joint taskforce made up of European and Chinese fast patrol vehicles identifies the vessel that was believed to have struck the station, tracking it to a distant location in the oort belt. High-speed drones, capable of reaching 10% of the speed of light are sent to the region, where they return signitures of a large number of stations and spacecraft.
