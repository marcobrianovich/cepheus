...
Named after the son of the god, Ares (Called Mars, by the Romans), Phobos is the larger of the two martian moons and is believed to formed out of a debris ring that was created when a small planetoid smashed into Mars. In time, the ring coalesced into the bumpy ball of rock and ice that we see today. Initially ignored by the first generation of settlers, Phobos and its brother were settled after they were mined for water and volatiles. 
