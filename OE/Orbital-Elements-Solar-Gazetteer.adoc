...
In the early days of colonisation, Callisto was considered the "goldilocks" location for settling. It's orbits Jupiter just outside the deadly radiation belts and is far enough away to not fall into Jupiter's steep gravity well, making early travel there significantly cheeper. 
