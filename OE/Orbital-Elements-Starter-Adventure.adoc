...
[NOTE]
====
On transporters that are set up for large numbers of decks, the emergency airlocks on each deck can be fitted with inflatable access tubes to provide additional access points. This arrangement is not in use on the Golden Goose.
====
