...
Indicates the racial or ethnic makeup of the settlement. Large settlements, founded to relieve population pressures in Earth's archologies are predominantly made up of the originating nation's races and ethnic groups. Also indicates the most popular languages on the station.
...
|A
|Abject
|You're living in a steel can. You have light, heat, air and water, but there is no redundancy. Lose a vital utility and it'll be all spanners and space suits for you. This is colonisation on a shoestring, or a temporary outpost. Class-A outposts are not sustainable. Sooner or later something breaks. Keep the certification on your space suit up-to-date. At most, there are very limited means of production. Food and parts are mostly shipped-in from outside.

|B
|Basic
|The steel can that you are living in has been upgraded. It's bigger, with Better shielding and muliple redundant systems so that a life support failure isn't an emergency, providing the backup doesn't then fail. New and or not well funded settlements tend to be Class-B. Temporary outposts that have good funding can be Class-C. There are workshops and greenhouses/food vats, but not really to the point of being completly self-sustaining. 
...
|2
|Company/Corporation
|Government through an organisation or comporate body. A board of directors and or shareholders are in control. In some settlements, all workers may be shareholders. Elsewhere, the corporation rules from a far-away head office and the settlers have no representation. 

|3
|Participating Democracy
|Citizens vote directly on all matter. In some settlements, citizens are bombared with online questionaires that are used to drive government policy. Elsewhere, citizens attend townhall meetings where policy is agreed through debates and voting.

|4
|Self-perpetuating Oligarchy
|Government by a small elite. There is no formal mechanism for answering to the will of the people.

|5
|Representative Democracy
|Citizens vote for leaders, who then represent the citizens. Other types of governments may have systems for widespread voting, but the right to vote is very restricted. By contrast, a participating democracy must minimise restrictions to voting.

|6
|Feudal Technocracy
|Rule by a small group of individuals who hold power by virtue of technical or professional qualification. Power is slit between a number of agencies that then hold power over subordinate agencies. Feudal societies are personality-lead and decision making doesn't come from comittees it comes from designated leaders.

|7
|Colony/occupational government
|Government from an external body, such as the government of a home nation of the colony, or sometimes as a result of a military take-over.

|1
|Balkanization
|Settlements where there is no central rule. This could mean that various groups fight for control or that the settlement is split into sectors, each with its own rule.

|8
|Civil Service Bureaucracy
|Rule is handled by a wing of the civil service, which treats decision making as just another government task.

|9
|Impersonal Bureaucracy
|Government by an agency that operates in isolation from the governed. The system ensures that the government is imunised against corruption because they operate in isolation from the populace.

|10
|Charismatic Dictator
|Government by a single leader who enjoys the widespread approval of the settlement's population.

|11
|Non-Charismatic Leader
|Governed by the person who took over from the charismatic dictor. Looking at you, North Korea.

|12
|Charismatic Oligarchy
|Government by a small group that enjoys overwhelming approval from the settlement's population. 

|13
|Religious Dictatorship
|Government by agencies that are controlled by religious leaders. All areas of government therefore take on a religious overtone.

|14
|Religious Autocracy
|Government by a single religous leader, holding absolute power over the settlement.

|15
|Totalitarian Oligarchy
|Government by a dominant group of citizens who hold absolute power over the populace. 
...
[cols="10%,20%,70%"]
|===
|Law Level code |Law Level Label |Law Level Description Description

|0
|Now Law
|No Prohibitions. Wild west after someone shoots the sherrif. 

|1
|Lax
|Only the most severe breaches in conduct, such as murder, violent crime are prosecuted. No prohibitions against carrying weapons of any kind.

|2
|Relaxed
|There is a fully operational criminal justice system, although it is quite rare for prosecutions to occur. Often those accused of a crime will ostracized by the community rather than face legal consequences for their actions.

|3
|Moderate
|The legal system is well balanced, dealing with serious crimes harshly, while responding lightly to less serious transgressions. 

|4
|Restrictive
|The legal system deals with all crimes harshly. 

|5
|Prohibitive
|The legal system deals with all crimes harshly and defines crimes more broadly. Operating under a prohibitive legal system can be a minefield where seemingly minor transgressions can result in lengthy prison terms.

|6
|Extremist
|A criminal justice system that made almost everything a crime and therefore provides little justice. Few places operate under such cruelty for long. Extremist law-levels are often a sign of a recent coup or attempted coup, or of a government that is using the law as a tool of oppression against the populous. 

|===

===  Attitude

The Attitude of the settlement to outsiders.

[cols="10%,20%,70%"]
|===
|Attitude code |Attitude Label |Attitude Description

|1
|Open
|Open settlements have absolutely no restriction on visitors

|2
|Open with registration
|Open but require visitors to identify themselves and register on arrival. The process is used to manage visitor numbers and track when vistors leave.

|3
|Open with visa
|Open but requires visitors to obtain a visa before arrival. Visas limit what a visitor can do at the settlement and how long they may stay. Some settlements will allow visas to be obtained on arrival, although in this case the visitor may be confined to a port area until issued.

|4
|Restricted 
|Settlements or facilities that are private holdings are restricted. Access to outsiders can only be granted to the owners or managers of the facility. Being found in a settlement without permission will normally result in immediate ejection. If the facility falls inside a legal juristiction then police may be informed and the visitor may face prosecution for trespass.

|5
|Closed
|A closed settlement is strictly not open to visitors, such as reseach labs or a corporate retreats. There may security that ensures that visitors don't crash the site, but the site not particularly structured for security.

|6
|High-Security
|The settlement or facility is completely restrictued and visitors attempting to enter without permission will be immediately arrested. This is the standard arrangement for military bases, prisons and secret badguy bases.
|===
