...
|Citizens vote directly on all matter. Other types of governments may have systems for widespread voting, but the right to vote is very restricted. By contrast, a participating democracy must minimise restrictions to voting.
