...
Before the stations can be indentified, Some AI communicate with the United Nations that they believe that a faction of AI has established its own stations, as a response to recent attacks on AI.
