...
*2030* First Mars landing. There's already a perminent base on the Moon.
...
*2109* The United States, India, Morocco and the European Federation each start programs to follow China's lead.
