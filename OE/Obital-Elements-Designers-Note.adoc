...
*2110*  More than ninty percent of Earth's population now live in archologies. Autonomous Manufacturing Plants can quickly and cheaply build weather-proof underground habitats, allowing archologies to establish bunker communities to aleviate population pressure. M
...
*2165* There are now more than 100 colonies or outposts stretching from a solar research station that orbits close to the sun, right out to Kuiper belt with outposts on 
